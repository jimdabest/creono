        ...
        <div class="product-action-card" style="background: var(--apple-card-bg, #fff); border-radius: 24px; padding: 32px; border: 1px solid rgba(0,0,0,0.08); box-shadow: 0 4px 24px rgba(0,0,0,0.04); position: sticky; top: 90px;">
            ...
            <div class="action-buttons" style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 24px;">
                ...
                <button type="button" id="btnAddToCart" class="btn btn-primary btn-block" data-product-id="<?php echo $data['product']->id; ?>" style="padding: 14px; font-size: 16px; font-weight: 600; border-radius: 14px; background: var(--apple-blue, #0071e3); border: none; color: #fff; cursor: pointer; transition: all 0.2s ease; display: flex; align-items: center; justify-content: center; gap: 8px;">
                    ...
                    <span><?php echo $data['in_cart'] ? '✓ Đã có trong giỏ' : 'Thêm vào giỏ hàng'; ?></span>
                </button>

                <!-- Toggle Favorite (UC17) -->
                <button type="button" id="btnToggleFavorite" class="btn btn-secondary btn-block" data-product-id="<?php echo $data['product']->id; ?>" style="padding: 14px; font-size: 16px; font-weight: 600; border-radius: 14px; background: #f5f5f7; border: 1px solid rgba(0,0,0,0.08); color: <?php echo $data['is_favorited'] ? '#ff3b30' : '#1d1d1f'; ?>; cursor: pointer; transition: all 0.2s ease; display: flex; align-items: center; justify-content: center; gap: 8px;">
                    <svg class="fav-icon" width="20" height="20" viewBox="0 0 24 24" fill="<?php echo $data['is_favorited'] ? '#ff3b30' : 'none'; ?>" stroke="<?php echo $data['is_favorited'] ? '#ff3b30' : 'currentColor'; ?>" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                    <span id="favText"><?php echo $data['is_favorited'] ? 'Đã yêu thích' : 'Yêu thích'; ?></span>
                </button>
