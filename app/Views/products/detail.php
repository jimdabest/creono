...
<?php if (!empty($data['product']->preview_url)) : ?>
    <!-- Thumbnail mở bản xem trước có đóng dấu -->
        <div class="product-preview-container" id="btnSellerPreview" 
         style="cursor: pointer; margin-bottom: 28px; border-radius: 16px; overflow: hidden; border: 1px solid rgba(0,0,0,0.08); position: relative; background: #0b0c10; text-align: center;"
            title="Nhấn để xem bản xem trước có đóng dấu bản quyền">
        ...
        <div style="position: absolute; bottom: 12px; right: 12px; background: rgba(0,0,0,0.65); color: #fff; font-size: 12px; font-weight: 500; padding: 4px 10px; border-radius: 20px; backdrop-filter: blur(4px);">
            🔒 Bản xem trước có đóng dấu bản quyền Creono (Nhấn để xem)
        </div>
    </div>
