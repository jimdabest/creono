    ...
    <div class="product-grid">
        <?php if(!empty($data['products'])) : ?>
            <?php foreach($data['products'] as $product) : ?>
                ...
                <div class="product-card interactive-hover" style="border-radius: 24px; position: relative;">
                    ...
                    <div class="product-footer">
                        ...
                        <div style="display: flex; gap: 8px; align-items: center;">
                            ...
                            <button type="button" class="btn-cart-add-mini" data-product-id="<?php echo $product->id; ?>" style="background: var(--apple-blue, #0071e3); border: none; color: #fff; width: 36px; height: 36px; border-radius: 10px; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: transform 0.15s ease;" title="Thêm vào giỏ hàng">
    ...
    document.addEventListener('click', function(e) {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                setTimeout(function() {
                    btn.innerHTML = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>';
