...
<div class="auth-page">
    <div class="glass-card">
        ...
        <form action="<?php echo URLROOT; ?>/users/register" method="POST" id="registerForm" data-ajax="true">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" 
                       ...
                       required>
                <span class="error-text" id="name_err" <?php echo !empty($data['errors']['name_err']) ? 'style="display: block;"' : ''; ?>><?php echo htmlspecialchars($data['errors']['name_err'] ?? ''); ?></span>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" name="confirm_password" id="confirm_password" 
                       class="form-control <?php echo !empty($data['errors']['confirm_password_err']) ? 'is-invalid' : ''; ?>" 
                       value="<?php echo isset($data['confirm_password']) ? htmlspecialchars($data['confirm_password']) : ''; ?>"
                       placeholder="Nhập lại mật khẩu"
                       required>
                <span class="error-text" id="confirm_password_err" <?php echo !empty($data['errors']['confirm_password_err']) ? 'style="display: block;"' : ''; ?>><?php echo htmlspecialchars($data['errors']['confirm_password_err'] ?? ''); ?></span>
            </div>
